                    ...
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" action="{{ route('event.update', $event->id) }}" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control" name="event_startdate"
                                            id="event_startdate" value="{{ $event->event_startdate }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="time" class="form-control" name="event_starthour"
                                            id="event_starthour" value="{{ $event->event_starthour }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                            ...
                                            <div class="row">
                                                <div class="col-5">
                                                    <input type="text" class="form-control" placeholder="lat" name="lat"
                                                        id="lat" value="{{ $event->latitude }}">
                                                </div>
                                                <div class="col-5">
                                                    <input type="text" class="form-control" placeholder="lng" name="lng"
                                                        id="lng" value="{{ $event->longitude }}">
                                                </div>
                                            </div>

                                            <div id="map1" style="height:400px; width: 800px;" class="my-3"></div>
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-info">Editar Evento</button>
